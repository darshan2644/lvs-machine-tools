    ...
    <nav className={`navbar ${isScrolled ? 'navbar-scrolled' : ''}`}>
      <div className="navbar-container">
        ...
        <Link to="/" className="navbar-logo">
          <img src="/images/lvs-logo.png" alt="LVS Tools" className="logo-image" />
          <span className="logo-text">LVS TOOLS</span>
        </Link>
        ...
        <ul className="navbar-menu">
          ...
          <li className="navbar-item dropdown">
            ...
            <ul className="dropdown-menu">
              <li><Link to="/category/cnc-machines" className="dropdown-link">CNC Machines</Link></li>
              <li><Link to="/category/lathes" className="dropdown-link">Lathes</Link></li>
              <li><Link to="/category/milling-machines" className="dropdown-link">Milling Machines</Link></li>
              <li><Link to="/category/drill-presses" className="dropdown-link">Drill Presses</Link></li>
              <li><Link to="/category/grinders" className="dropdown-link">Grinders</Link></li>
              <li><Link to="/category/welding-equipment" className="dropdown-link">Welding Equipment</Link></li>
            </ul>
          </li>
          <li className="navbar-item">
